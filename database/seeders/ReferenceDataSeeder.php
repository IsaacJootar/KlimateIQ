...
class ReferenceDataSeeder extends Seeder
{
    ...
    private function seedRegions(): void
    {
        ...
        $this->seedRiverReaches();
    }

    /**
     * Curated GloFAS sample points on the Niger and Benue for the confluence-corridor LGAs
     * (T4/T5 follow-up). Bundled JSON, idempotent upsert on (region_id, reach) — the same
     * pattern as seedRemainingNigerianLgas(). An LGA not listed keeps scoring at its centroid.
     */
    private function seedRiverReaches(): void
    {
