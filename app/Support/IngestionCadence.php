...
{
    public const DAILY = ['RAINFALL', 'STANDING_WATER', 'TEMPERATURE', 'AIR_QUALITY_PM25', 'AIR_QUALITY_PM10', 'OZONE', 'NO2', 'SOIL_MOISTURE', 'EVAPOTRANSPIRATION', 'HUMIDITY', 'WIND_SPEED', 'DUST', 'ACTIVE_FIRE', 'RIVER_DISCHARGE'];
