            ...
            <div class="section-card overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-4 py-8 text-center text-sm text-gray-500">No reports yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                <div class="section-card overflow-hidden">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-8 text-center text-sm text-gray-500">Nobody in your agency has shared a report yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
