                    ...
                    @forelse ($topRiskRegions as $i => $row)
                        <li class="flex items-center gap-4 px-5 py-3">
                            ...
                            @if (! empty($row['probability']))
                                <span class="text-xs font-semibold text-sky-700 dark:text-sky-300" title="Forecast: chance of reaching high risk (67+) within the next 2 weeks">≈{{ $row['probability'] }}%</span>
                            @endif
