...
class ScheduledIngestionCadenceTest extends TestCase
{
    ...
    {
        $event = $this->findEvent('signals:ingest --source=RAINFALL,STANDING_WATER,TEMPERATURE,AIR_QUALITY_PM25,AIR_QUALITY_PM10,SOIL_MOISTURE,EVAPOTRANSPIRATION,HUMIDITY,WIND_SPEED,DUST');
